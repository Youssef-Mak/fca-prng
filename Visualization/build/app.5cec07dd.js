...
},{}],"src/ECA/ECA.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.ElementaryCellularAutomata = void 0;

var ElementaryCellularAutomata =
/** @class */
function () {
  function ElementaryCellularAutomata(rule_number, size) {
    if (size === void 0) {
      size = 10;
    }
  ...
  ElementaryCellularAutomata.prototype.decipherRule = function (rule_number) {
    var ruleMapping = {};
    var binaryRule = (rule_number >>> 0).toString(2); // Convert to 8 bit

    while (binaryRule.length != 8) {
      binaryRule = "0" + binaryRule; // Hacky
    }

    for (var i = 0; i < binaryRule.length; i++) {
      var ruleKey = (binaryRule.length - (i + 1) >>> 0).toString(2);
  ...
  ElementaryCellularAutomata.prototype.getState = function () {
    return this.state;
  };

  ElementaryCellularAutomata.prototype.getPrevious = function () {
    return this.previous;
  };

  ElementaryCellularAutomata.prototype.nextIteration = function () {
    var newState = "";
    ...
    for (var i = 0; i < this.state.length; i++) {
      ...
      var max = i + 1;
      var min = i - 1;
      var maxElem = max == this.state.length ? this.state.charAt(0) : this.state.charAt(max);
      var minElem = min == -1 ? this.state.charAt(this.state.length - 1) : this.state.charAt(min);
      var neighbourhood = minElem + this.state.charAt(i) + maxElem;
...
exports.ElementaryCellularAutomata = ElementaryCellularAutomata;
},{}],"src/FCA/FCA.ts":[function(require,module,exports) {
"use strict";
...
exports.FuzzyCellularAutomata = void 0;

var ECA_1 = require("../ECA/ECA");

var FuzzyCellularAutomata =
/** @class */
function (_super) {
  __extends(FuzzyCellularAutomata, _super);

  function FuzzyCellularAutomata(rule_number, size) {
    if (size === void 0) {
      size = 10;
    }

    var _this = _super.call(this, rule_number, size) || this;

    _this.state = _this.state.split('').map(function (s) {
      return +s;
    });
    _this.state[30] = 0.5;
    _this.previous = [];
    _this.dnfTerms = Object.keys(_this.rule).filter(function (key) {
      return _this.rule[key] === "1";
    }).map(function (entry) {
      return FuzzyCellularAutomata.dnfEntries[entry];
    });
    _this.dnf = _this.generateDNF();
    return _this;
  }

  FuzzyCellularAutomata.prototype.generateDNF = function () {
    var _this = this;

    return function (p, r, q) {
      var res = 0;

      for (var _i = 0, _a = _this.dnfTerms; _i < _a.length; _i++) {
        var term = _a[_i];
        res += term(p, r, q);
      }
  ...
  FuzzyCellularAutomata.prototype.getState = function () {
    return this.state;
  };

  FuzzyCellularAutomata.prototype.getPrevious = function () {
    return this.previous;
  };

  FuzzyCellularAutomata.prototype.nextIteration = function () {
    var newState = [];
    ...
    for (var i = 0; i < this.state.length; i++) {
      ...
      var max = i + 1;
      var min = i - 1;
      var maxElem = max == this.state.length ? this.state[0] : this.state[max];
      var minElem = min == -1 ? this.state[this.state.length - 1] : this.state[min];
      var _a = [minElem, this.state[i], maxElem],
          p = _a[0],
          q = _a[1],
          r = _a[2];
  ...
  FuzzyCellularAutomata.dnfEntries = {
    "000": function _(p, r, q) {
      return (1 - p) * (1 - r) * (1 - q);
    },
    "001": function _(p, r, q) {
      return (1 - p) * (1 - r) * q;
    },
    "010": function _(p, r, q) {
      return (1 - p) * r * (1 - q);
    },
    "011": function _(p, r, q) {
      return (1 - p) * r * q;
    },
    "100": function _(p, r, q) {
      return p * (1 - r) * (1 - q);
    },
    "101": function _(p, r, q) {
      return p * (1 - r) * q;
    },
    "110": function _(p, r, q) {
      return p * r * (1 - q);
    },
    "111": function _(p, r, q) {
      return p * r * q;
    }
  };
  return FuzzyCellularAutomata;
}(ECA_1.ElementaryCellularAutomata);

exports.FuzzyCellularAutomata = FuzzyCellularAutomata;
},{"../ECA/ECA":"src/ECA/ECA.ts"}],"src/app.ts":[function(require,module,exports) {
"use strict";
...
var sketch = function sketch(p5) {
  p5.setup = function () {
    var canvas = p5.createCanvas(600, 1200);
    canvas.parent("app");
    ...
    eca = new ECA_1.ElementaryCellularAutomata(+rule.value(), cols / 2);
    fca = new FCA_1.FuzzyCellularAutomata(+rule.value(), cols / 2);
  };

  var mySelectEvent = function mySelectEvent() {
    var ruleTitle = document.getElementById("rule-label");
  ...
  p5.draw = function () {
    ...
    for (var i = 0; i < rows; i++) {
      var state = fca.getState();
      console.log(state);

      for (var j = 0; j < state.length; j++) {
        var x = i * resolution;
        var y = j * resolution + 600;
        var color = ('000000' + (state[i] * 16777215).toString(16)).slice(-6);
        p5.fill('#' + color);
        p5.stroke(0);
        p5.rect(x, y, resolution - 1, resolution - 1);
      }
...
},{"p5":"node_modules/p5/lib/p5.min.js","./ECA/ECA":"src/ECA/ECA.ts","./FCA/FCA":"src/FCA/FCA.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
